...
The test case implemented within this repository implements what the [OpenFOAM adapter validation paper](https://journal.openfoam.com/index.php/ofj/article/view/88/78) refer to as `fine` mesh.

This means the `Solid` participant modelled in OpenRadioss is discretized with 3072 `HEX20` solid elements, arranged with a 8 x 16 x 24 cell resolution along the three spatial directions.
