...
The goal of this simulation is to investigate whether the Radioss adaptive time step is affected by the `time-window-size` imposed by preCICE. 
Here the `time-window-size` imposed is set equal to `time-window-size = 1e-5s`.
